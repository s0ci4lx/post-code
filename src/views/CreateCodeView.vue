<template>
    <div class="bg-gray-100 min-h-screen flex items-center justify-center">
      <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-2xl">
        <h1 class="text-2xl font-bold mb-4 text-gray-800">Save Code to Google Sheet</h1>
  ...
  // URL ของ Web App
  const WEB_APP_URL = "https://script.google.com/macros/s/AKfycbyg3FXC4lQAR1lVODVPOjAqIq5vYEWvRhM5bYTOl6BAqIgbKC5o4VQfmuedSsmkeSaf/exec"; // แทนที่ด้วย URL ของ Apps Script
